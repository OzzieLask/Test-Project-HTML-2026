...
function setup() {
  ...
  canvas.position(0, 0);
  canvas.style('z-index', '-1'); // -1 makes it BEHIND other elements
  ...
  repelDist = circleSize * 1.5; // Distance for repulsion effect
...
function draw() {
  background(255, 0.08, 100, -50);

  let c = color(50, 150, 150,);
